        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CombinationKey = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    DisplayLabel = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    RawCombination = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocks_ProductVariantCombinations_CombinationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantCombinations_ProductId_CombinationKey",
